    ...
    <>
      <section className="ftco-section">
        <div className="container">
          {isMessageSent ? <ShowMessageBox isMessageSentUpdater={isMessageSentUpdater} isMessageSent={isMessageSent} {...props} /> : <></>}
          {isUserLoggin ? <ShowMessages {...props} /> : <ShowIndex />}
          <br />
          <br />
        </div>
      </section>
...
const ShowMessageBox = (props) => {
  ...
  return (
    <>
      <div className="row">
        <div className="col-lg-8 ">
          <h5 className="mb-3">{"Message Send To #" + user}</h5>
